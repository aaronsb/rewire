...
(function(){
  const HELP={
    ...
    shaper:{ _:"Shapes a clock's timing FEEL without changing its tempo. Patch CLOCK → SHAPER → voice; branch the clock to shape some voices and leave others straight. Chains with MULT and other shapers.",
      swing:"Adds shuffle on top of the clock's own swing — delays every other 16th. 0% = nothing added.",
      nudge:"Pushes this branch ahead of (−) or behind (+) the beat, in milliseconds. Negative rushes, positive lays back.",
      humanize:"Randomizes each hit's timing and volume slightly for a less mechanical, played-by-hand feel. 0% = dead robotic." },
    ...
    bass:{ _:"Bass voice. Reads the chord; STYLE picks the bassline algorithm — or wire a MOTIF and pick 'motif' to play a composed bassline.",
      style:"Bassline pattern: sustain, pulse, walking, octaves, arp, offbeat, driving, sub — or 'motif' to play a wired MOTIF as a composed line (steady eighths, in the bass register).",
      motif:"Optional MOTIF input. Wire one in and set STYLE to 'motif' for a composed bassline. Share a MOTIF with a lead for an octave-locked riff.",
